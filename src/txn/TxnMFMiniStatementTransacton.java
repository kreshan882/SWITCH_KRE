...
public class TxnMFMiniStatementTransacton {
	...
	public ISOMsg doProcessRequest(ISOMsg requestMsg,TxnKeyWords keyWD)throws Exception{
		...
		keyWD.setTXNTYPE(TxnTypeCodes.MF_MINI_STATEMENT);
		keyWD.setTXNNAME(TxnTypeCodes.MF_NAME_MINI_STATEMENT_TXN);
		...
		if(ResponseCode.SUCCESS.equals(keyWD.getRESPONSECODE())){
			...
			resMsg.set(61,resMsg.getString(59)); 	// Field 59 causes to a System Error in POS 
			resMsg.unset(59);						// Field 59 causes to a System Error in POS
