...
public class TxnMFBalanceInqueryTransaction {
	...
	public ISOMsg doProcessRequest(ISOMsg requestMsg,TxnKeyWords keyWD)throws Exception{
		...
		keyWD.setTXNTYPE(TxnTypeCodes.MF_BALANCE_INQUERY);
		keyWD.setTXNNAME(TxnTypeCodes.MF_NAME_BALANCE_INQUERY_TXN);
		...
		if(ResponseCode.SUCCESS.equals(keyWD.getRESPONSECODE())){
			...
			requestMsg.unset(54); // ACC Balance by Chandana 2010/03/17
