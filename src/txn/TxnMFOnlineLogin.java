...
public class TxnMFOnlineLogin {
	...
	public ISOMsg doProcessRequest(ISOMsg requestMsg, TxnKeyWords keyWD)throws Exception {
		...
		keyWD.setTXNTYPE(TxnTypeCodes.MF_ONLINE_LOGIN);
		keyWD.setTXNNAME(TxnTypeCodes.MF_NAME_ONLINE_LOGIN);
