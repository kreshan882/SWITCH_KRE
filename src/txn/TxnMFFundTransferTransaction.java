...
public class TxnMFFundTransferTransaction {
	...
	public ISOMsg doProcessRequest(ISOMsg requestMsg,TxnKeyWords keyWD)throws Exception{
		...
		keyWD.setTXNTYPE(TxnTypeCodes.MF_FUND_TRANSFER);
		keyWD.setTXNNAME(TxnTypeCodes.MF_NAME_FUND_TRANSFER_TXN);
		...
		if(ResponseCode.SUCCESS.equals(keyWD.getRESPONSECODE())){
			...
			resMsg.unset(54);	// ACCOUNT BALANCE
